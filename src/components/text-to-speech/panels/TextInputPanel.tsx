...
import VoiceSelectorButton from "../buttons/VoiceSelectorButton"
import SettingsDrawer from "./settings/tabs/mobile/SettingsDrawer"
import HistoryDrawer from "./settings/tabs/mobile/HistoryDrawer";
      ...
      <div className="shrink-0 p-4 lg:p-6">
        ...
        {text.length > 0 ? (
          ...
          <div className="hidden lg:block">
            <PromptSuggestions
              onSelect={(prompt) => Textform.setFieldValue("text", prompt)}
            />
          </div>
        )}
      </div>
