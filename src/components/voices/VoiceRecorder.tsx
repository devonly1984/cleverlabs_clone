...
const VoiceRecorder = ({
  ...
  if (error) {
    return (
      <div className="flex flex-col items-center gap-4 rounded-2xl border px-6 py-10 border-destructive/50 bg-destructive/5">
    ...
    return (
      <div className="flex flex-col overflow-hidden rounded-2xl border">
        ...
        <div className="flex items-center justify-between border-t p-4">
          <p className="font-semibold tracking-tight leading-[1.2] text-[28px]">
